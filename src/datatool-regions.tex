...
The format can be adjusted by redefining
\cs{DTLdefaultEURcurrencyfmt} (provided by \sty{datatool-base}
v3.0+). Note that this is general to all regions that use \qt{EUR}
as the currency.
